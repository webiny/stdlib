...
Implements `Cache.Interface` from `@webiny/utils-common`. See the `@webiny/utils-common` [Cache feature](../../../../../../common/src/features/Cache/README.md) for the full `ICache` interface.
...
import { Cache } from "@webiny/utils-common";
import { LocalStorageCacheFeature } from "@webiny/utils-browser";
